...
class HomePage extends Component {
    ...
    EvChange1_1 = (e) => {
      if(this.state.slot1EVs < 510){
        this.setState({
          slot1stat1: e,
          slot1EVs: this.state.slot1stat1 + this.state.slot1stat2 + this.state.slot1stat3 + this.state.slot1stat4 + this.state.slot1stat5 + this.state.slot1stat6
        })
      } else{
        return
      }
    ...
    slot2ItemSelect = (e) => {
      this.props.AddSlot2Item(e.target.value)
    }
    slot3ItemSelect = (e) => {
      this.props.AddSlot3Item(e.target.value)
    }
    slot4ItemSelect = (e) => {
      this.props.AddSlot4Item(e.target.value)
    }
    slot5ItemSelect = (e) => {
      this.props.AddSlot5Item(e.target.value)
    }
    slot6ItemSelect = (e) => {
      this.props.AddSlot6Item(e.target.value)
    }
    render () {
        ...
        <div style={{backgroundImage: `url(https://ih1.redbubble.net/image.236310472.7095/flat,1000x1000,075,f.u2.jpg)`}}>
            ...
            {this.props.slot1.sprites.front_shiny ? <button onClick={() => this.showshiny('slot1shiny')}>Show Shiny</button> : null}
                ...
                <div className="column is-4">
                    <p>stats:</p>
                    <ul>
                        <li style={{padding: 10}}>{this.props.slot1.stats[0].stat.name} - {Math.floor(this.props.slot1.stats[0].base_stat + (this.state.slot1stat1 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat1} onChange={this.EvChange1_1}/> : null }</li>
                        <li style={{padding: 10}}>{this.props.slot1.stats[1].stat.name} - {Math.floor(this.props.slot1.stats[1].base_stat + (this.state.slot1stat2 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat2} onChange={this.EvChange1_2} /> : null}</li>
                        <li style={{padding: 10}}>{this.props.slot1.stats[2].stat.name} - {Math.floor(this.props.slot1.stats[2].base_stat + (this.state.slot1stat3 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat3} onChange={this.EvChange1_3} /> : null}</li>
                        <li style={{padding: 10}}>{this.props.slot1.stats[3].stat.name} - {Math.floor(this.props.slot1.stats[3].base_stat + (this.state.slot1stat4 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat4} onChange={this.EvChange1_4}/> : null}</li>
                        <li style={{padding: 10}}>{this.props.slot1.stats[4].stat.name} - {Math.floor(this.props.slot1.stats[4].base_stat + (this.state.slot1stat5 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat5} onChange={this.EvChange1_5}/> : null}</li>
                        <li style={{padding: 10}}>{this.props.slot1.stats[5].stat.name} - {Math.floor(this.props.slot1.stats[5].base_stat + (this.state.slot1stat6 / 4))} - EV input {this.state.slot1EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot1stat6} onChange={this.EvChange1_6}/> : null}</li>
                    </ul>
                    <p>held item:</p>
                    <select onChange={this.slot1ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot1Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
            ...
            <div className="box columns" style={{borderStyle: 'ridge', margin: 20, boxShadow: '10px 10px 18px -5px rgba(0,0,0,0.75)'}}>
                ...
                <p>stats:</p>
                <ul>
                    <li style={{padding: 10}}>{this.props.slot2.stats[0].stat.name} - {Math.floor(this.props.slot2.stats[0].base_stat + (this.state.slot2stat1 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat1} onChange={this.EvChange2_1}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot2.stats[1].stat.name} - {Math.floor(this.props.slot2.stats[1].base_stat + (this.state.slot2stat2 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat2} onChange={this.EvChange2_2}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot2.stats[2].stat.name} - {Math.floor(this.props.slot2.stats[2].base_stat + (this.state.slot2stat3 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat3} onChange={this.EvChange2_3}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot2.stats[3].stat.name} - {Math.floor(this.props.slot2.stats[3].base_stat + (this.state.slot2stat4 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat4} onChange={this.EvChange2_4}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot2.stats[4].stat.name} - {Math.floor(this.props.slot2.stats[4].base_stat + (this.state.slot2stat5 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat5} onChange={this.EvChange2_5}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot2.stats[5].stat.name} - {Math.floor(this.props.slot2.stats[5].base_stat + (this.state.slot2stat6 / 4))} - EV input {this.state.slot2EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot2stat6} onChange={this.EvChange2_6}/> : null}</li>
                </ul>
                <p>held item:</p>
                    <select onChange={this.slot2ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot2Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
            ...
            <div className="box columns" style={{borderStyle: 'ridge', margin: 20, boxShadow: '10px 10px 18px -5px rgba(0,0,0,0.75)'}}>
                ...
                <p>stats:</p>
                <ul>
                    <li style={{padding: 10}}>{this.props.slot3.stats[0].stat.name} - {Math.floor(this.props.slot3.stats[0].base_stat + (this.state.slot3stat1 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat1} onChange={this.EvChange3_1}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot3.stats[1].stat.name} - {Math.floor(this.props.slot3.stats[1].base_stat + (this.state.slot3stat2 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat2} onChange={this.EvChange3_2}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot3.stats[2].stat.name} - {Math.floor(this.props.slot3.stats[2].base_stat + (this.state.slot3stat3 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat3} onChange={this.EvChange3_3}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot3.stats[3].stat.name} - {Math.floor(this.props.slot3.stats[3].base_stat + (this.state.slot3stat4 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat4} onChange={this.EvChange3_4}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot3.stats[4].stat.name} - {Math.floor(this.props.slot3.stats[4].base_stat + (this.state.slot3stat5 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat5} onChange={this.EvChange3_5}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot3.stats[5].stat.name} - {Math.floor(this.props.slot3.stats[5].base_stat + (this.state.slot3stat6 / 4))} - EV input {this.state.slot3EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot3stat6} onChange={this.EvChange3_6}/> : null}</li>
                </ul>
                <p>held item:</p>
                    <select onChange={this.slot3ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot3Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
            ...
            <div className="box columns" style={{borderStyle: 'ridge', margin: 20, boxShadow: '10px 10px 18px -5px rgba(0,0,0,0.75)'}}>
                ...
                <p>stats:</p>
                <ul>
                    <li style={{padding: 10}}>{this.props.slot4.stats[0].stat.name} - {Math.floor(this.props.slot4.stats[0].base_stat + (this.state.slot4stat1 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat1} onChange={this.EvChange4_1}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot4.stats[1].stat.name} - {Math.floor(this.props.slot4.stats[1].base_stat + (this.state.slot4stat2 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat2} onChange={this.EvChange4_2}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot4.stats[2].stat.name} - {Math.floor(this.props.slot4.stats[2].base_stat + (this.state.slot4stat3 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat3} onChange={this.EvChange4_3}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot4.stats[3].stat.name} - {Math.floor(this.props.slot4.stats[3].base_stat + (this.state.slot4stat4 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat4} onChange={this.EvChange4_4}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot4.stats[4].stat.name} - {Math.floor(this.props.slot4.stats[4].base_stat + (this.state.slot4stat5 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat5} onChange={this.EvChange4_5}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot4.stats[5].stat.name} - {Math.floor(this.props.slot4.stats[5].base_stat + (this.state.slot4stat6 / 4))} - EV input {this.state.slot4EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot4stat6} onChange={this.EvChange4_6}/> : null}</li>
                </ul>
                <p>held item:</p>
                    <select onChange={this.slot4ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot4Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
            ...
            <div className="box columns" style={{borderStyle: 'ridge', margin: 20, boxShadow: '10px 10px 18px -5px rgba(0,0,0,0.75)'}}>
                ...
                <p>stats:</p>
                <ul>
                    <li style={{padding: 10}}>{this.props.slot5.stats[0].stat.name} - {Math.floor(this.props.slot5.stats[0].base_stat + (this.state.slot5stat1 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat1} onChange={this.EvChange5_1}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot5.stats[1].stat.name} - {Math.floor(this.props.slot5.stats[1].base_stat + (this.state.slot5stat2 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat2} onChange={this.EvChange5_2}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot5.stats[2].stat.name} - {Math.floor(this.props.slot5.stats[2].base_stat + (this.state.slot5stat3 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat3} onChange={this.EvChange5_3}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot5.stats[3].stat.name} - {Math.floor(this.props.slot5.stats[3].base_stat + (this.state.slot5stat4 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat4} onChange={this.EvChange5_4}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot5.stats[4].stat.name} - {Math.floor(this.props.slot5.stats[4].base_stat + (this.state.slot5stat5 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat5} onChange={this.EvChange5_5}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot5.stats[5].stat.name} - {Math.floor(this.props.slot5.stats[5].base_stat + (this.state.slot5stat6 / 4))} - EV input {this.state.slot5EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot5stat6} onChange={this.EvChange5_6}/> : null}</li>
                </ul>
                <p>held item:</p>
                    <select onChange={this.slot5ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot5Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
            ...
            <div className="box columns" style={{borderStyle: 'ridge', margin: 20, boxShadow: '10px 10px 18px -5px rgba(0,0,0,0.75)'}}>
                ...
                <p>stats:</p>
                <ul>
                    <li style={{padding: 10}}>{this.props.slot6.stats[0].stat.name} - {Math.floor(this.props.slot6.stats[0].base_stat + (this.state.slot6stat1 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat1} onChange={this.EvChange6_1}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot6.stats[1].stat.name} - {Math.floor(this.props.slot6.stats[1].base_stat + (this.state.slot6stat2 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat2} onChange={this.EvChange6_2}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot6.stats[2].stat.name} - {Math.floor(this.props.slot6.stats[2].base_stat + (this.state.slot6stat3 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat3} onChange={this.EvChange6_3}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot6.stats[3].stat.name} - {Math.floor(this.props.slot6.stats[3].base_stat + (this.state.slot6stat4 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat4} onChange={this.EvChange6_4}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot6.stats[4].stat.name} - {Math.floor(this.props.slot6.stats[4].base_stat + (this.state.slot6stat5 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat5} onChange={this.EvChange6_5}/> : null}</li>
                    <li style={{padding: 10}}>{this.props.slot6.stats[5].stat.name} - {Math.floor(this.props.slot6.stats[5].base_stat + (this.state.slot6stat6 / 4))} - EV input {this.state.slot6EVs < 510 ?  <NumericInput min={0} max={252} size='10' value={this.state.slot6stat6} onChange={this.EvChange6_6}/> : null}</li>
                </ul>
                <p>held item:</p>
                    <select onChange={this.slot6ItemSelect}>
                      {this.getItems()}
                    </select>
                    <p>Current Held Item: {this.props.slot6Item}</p>
                </div>
                <div className="column is-4">
                    <h1>Moves:</h1>
...
const mapStateToProps = (store) => {
    return {
      ...
      slot1Item: store.slot1Item,
      slot2Item: store.slot2Item,
      slot3Item: store.slot3Item,
      slot4Item: store.slot4Item,
      slot5Item: store.slot5Item,
      slot6Item: store.slot6Item,
    }
}
...
const mapDispatchToProps = (dispatch) => {
    return {
      ...
      AddSlot2Item: (item) => {
        dispatch({ type: "Add_slot2_item", slot2Item: item })
      },
      AddSlot3Item: (item) => {
        dispatch({ type: "Add_slot3_item", slot3Item: item })
      },
      AddSlot4Item: (item) => {
        dispatch({ type: "Add_slot4_item", slot4Item: item })
      },
      AddSlot5Item: (item) => {
        dispatch({ type: "Add_slot5_item", slot5Item: item })
      },
      AddSlot6Item: (item) => {
        dispatch({ type: "Add_slot6_item", slot6Item: item })
      },
    }
}
